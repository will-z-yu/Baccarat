...
public class Deck {
	...
	/*Methods*/
	public void makeDeck(){//initializes deck
		int k = 0;
	...
	public void shffuleDeck(Card[] inputDeck) {//shuffles deck
	...
	public void printDeck(Card[] inputDeck) {//print deck
	...
	public Card[] getDeck() {return this.cardDeck;}
